...
namespace ChatBot
{
    public static class Parser
    {
        ...
        private static List<string> EnglishJosa = new List<string>()
        {
            "a", "an", "the", "am", "are", "is", "were", "was"
        };
        ...
        public static string[] ParseEnglish(string input)
        {
